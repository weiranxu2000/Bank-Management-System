...
public class AccountRepositoryTest {
    ...
    @Test
    public void shouldFindByCardNumberAndPassword() {
        Optional<Account> account = accountRepository.findByCardNumberAndPassword(this.account.getCardNumber(), this.account.getPassword());
        assertThat(account).isPresent();
        assertThat(account.get()).isEqualTo(accountRepository.findAllByUser(user).get(0));
    }

    @Test
    public void shouldReturnEmptyOptionalWhenAccountDoesNotExistByCardNumberAndPassword() {
        Optional<Account> account = accountRepository.findByCardNumberAndPassword("invalid-card-number", "123456");
        assertThat(account).isEmpty();
    }
}
